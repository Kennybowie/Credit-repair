...
              Go to{" "}
              <span className="font-semibold text-white">EXPERIAN.COM</span> and
              create an account. When you sign up please{" "}
              <span className="font-semibold text-white">UPGRADE</span> the
              account and put a card on file to utilize the{" "}
              <span className="font-semibold text-white">FREE TRIAL</span> so we
              can see all 3 credit bureaus. You will not be charged as I will{" "}
              <span className="font-semibold text-white">DOWNGRADE</span> you to
              the free version before the free trial is up.
            </p>
