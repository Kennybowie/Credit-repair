...
              position themselves to get approved for lines of credit, loans,
              apartments, cars, etc.
            </p>
...
                Go to{" "}
                <span className="font-semibold text-white">EXPERIAN.COM</span>{" "}
                and create an account. When you sign up, please{" "}
...
                  </div>
                  <p className="mt-2">
                    You’ll get a text from me with the next step and what I need
